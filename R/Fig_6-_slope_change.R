...
postscript("plots/fig6.eps", horizontal = FALSE, onefile = FALSE, height = 6, width = 6, 
...
plot(c(0, 1), c(0, 1), type = "n", xlim = c(0, 1), ylim = c(0, 1), lwd = 1, axes = F, 
    ann = F, xaxs = "i", yaxs = "i")
